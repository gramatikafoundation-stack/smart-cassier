...
-- Version: 20260912165826  Name: frontend_performance_successful_sample_median_v2
...
with latest as (
 ...
 select coalesce(jsonb_object_agg(service_key,jsonb_build_object('status',status_code,'latest_latency_ms',latency_ms,'median_latency_30m_success_ms',median_latency_ms,'successful_samples_30m',samples,'payload_bytes',payload_bytes,'cache_control',cache_control,'measured_at',measured_at)),'{}'::jsonb) metrics,
