...
-- Harden the staged runtime resolver so explicit tenant + browser origin can be
-- verified against registered tenant aliases without weakening the compatibility bridge.
